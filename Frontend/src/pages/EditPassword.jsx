...
/* ── MOCK VAULT (same as ViewPassword) ── */
import {
  GlobeIcon as GI, BriefcaseIcon, MonitorIcon, MailIcon as MI, UserIcon as UI,
} from '../components/Icons';
...
export default function EditPassword() {
  ...
  const [form, setForm] = useState({
    ...
    email: '', password: '', category: 'Personal',
    tags: '', notes: '',
  });
  ...
  async function fetchItem() {
    try {
      ...
      if (!res.ok) { navigate('/passwords'); return; }
...
if (!existing) return <div className="db-shell" style={{display:'flex',alignItems:'center',justifyContent:'center',flex:1}}><span className="auth-spinner"/></div>;
  return (
