...
export default function Register() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // Save userId to pass to OTP page
      localStorage.setItem('lockify-userId', data.userId);
        ...
        <div className="auth-card">
          ...
          <form className="auth-form" onSubmit={handleSubmit} noValidate>
            ...
            <div className="auth-notice">
              <AlertTriangleIcon size={15} className="auth-notice-icon" />
              <span>We cannot recover your master password. Store it somewhere safe.</span>
            </div>
